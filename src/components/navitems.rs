...
pub(crate) fn NavItems(logout: LogoutSignal, username: UsernameSignal) -> impl IntoView {
    ...
    view! {
        ...
        //             <div class="flex flex-1 items-center justify-center sm:items-stretch sm:justify-start">
        //                 <div class="flex shrink-0 items-center">
        //                     //<img class="h-8 w-auto" src="https://tailwindcss.com/plus-assets/img/logos/mark.svg?color=indigo&shade=500" alt="GLAD" />
        //                     //<A class:navbar-brand=true href="/" exact=true>
        //                     <A href="/" exact=true>
        //                         <p class="px-3 py-1 text-lg font-bold text-green-300">
        //                         //<p class="rounded-md px-3 py-2 text-sm font-medium text-gray-300 hover:bg-gray-700 hover:text-white">
        //                             "glad"
        //                         </p>
        //                     </A>
        //                 </div>
        ...
        //                         <Show when=move || username.with(Option::is_some) fallback=move || {
        //                             view!{
        //                                 <A href="/signup">
        //                                     <div class="rounded-md px-3 py-2 text-sm font-medium text-gray-300 hover:bg-gray-700 hover:text-white">
        //                                         Sign up
        ...
        //                 </div>
        //             </div>
        //             <Show when=move || username.with(Option::is_some)>
        //                 <div class="absolute inset-y-0 right-0 flex items-center pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0">
        //                     <button
        //                         type="button"
        //                         class="relative rounded-full bg-gray-800 p-1 text-gray-400 hover:text-white focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-gray-800"
